...
Проект выполнен полностью самостоятельно изначально в рамках выпускной квалификационной работы и продолжает развиваться как самостоятельный продукт.
Я отвечала за:

- анализ аналогов и требований;
- проектирование пользовательских сценариев;
- разработку архитектуры;
- дизайн интерфейса в Figma;
- реализацию iOS-приложения;
- интеграцию внешнего API;
- локальное хранение данных;
- тестирование на реальных устройствах;
- подготовку сборки в TestFlight.

## Тестирование

Проведено функциональное тестирование ключевых сценариев на реальных устройствах и реализованы базовые unit-тесты с использованием XCTest.

Сейчас приложение проходит закрытое TestFlight-тестирование с участием трёх пользователей.

## Доступ к приложению

Исходный код приложения находится в приватном репозитории.

Демонстрация приложения и TestFlight-сборка доступны по запросу.

## Контакты

- Telegram: [@everythingisgoingtobeok](https://t.me/everythingisgoingtobeok)
- Email: [gilazudtinovaa@mail.ru](mailto:gilazudtinovaa@mail.ru)
